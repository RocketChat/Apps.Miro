...
export async function manageSubscriptionsModal({ app, modify, read, persistence, http, slashcommandcontext, uikitcontext }: IGenericModal): Promise<IUIKitSurfaceViewParam> {
